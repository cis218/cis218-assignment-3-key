...
You will only need two apps for this assignment. One for the accounts and one for the reviews. Both the Restaurant and Review model can live in the same app.
